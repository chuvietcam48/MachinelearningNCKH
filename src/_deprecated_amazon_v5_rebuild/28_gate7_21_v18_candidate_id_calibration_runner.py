#!/usr/bin/env python
"""Gate 7.21 v1.8 candidate-ID calibration runner.

v1.8 keeps the candidate-ID evidence architecture, returns to the v1.4
normalization baseline, and applies conservative general semantic guards.
"""
...
def normalize_v18(item: dict[str, Any]) -> None:
    BASE_NORMALIZE(item)
    text = text_of(item)
...
def configure_runner() -> None:
    runner.POLICY_VERSION = "semantic_policy_v1_8_candidate_id"
    runner.CAMPAIGN_ID = "V18CIDCALIBRATION_FRESH_V1"
    ...
    runner.apply_policy_normalization = normalize_v18
