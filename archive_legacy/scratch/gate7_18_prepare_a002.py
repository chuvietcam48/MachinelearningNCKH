...
approval_path = out_dir / "v151_candidate_id_calibration_live_approval_A002_gate7_18.json"
ps_path = repo / "scripts" / "run_v151_candidate_id_calibration_live_A002_gate7_18.ps1"
...
approval = {
    "approval_id": "GATE7_18_V151CIDCALIBRATION_A002_OPERATOR_APPROVAL",
    "attempt_id": "A002",
    "execution_mode": "LIVE",
    ...
    "scope": "Gate 7.18 v1.5.1 candidate-ID calibration after local wrapper recursion fix.",
    ...
    "operator_note": "A001 crashed due local wrapper recursion after provider call; no label repair; rerun as A002.",
}
...
$Approval = Join-Path $Repo "outputs\\amazon_v5_rebuild\\annotation\\v1_3_calibration_v2\\v151_candidate_id_calibration_live_approval_A002_gate7_18.json"
