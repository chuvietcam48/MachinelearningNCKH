...
$approvalFile = Join-Path $approvalDir "live_approval_V12EXP_PRIMARY_V3_P000002_P000010_A005.json"
...
$approval = [ordered]@{
    ...
    approval_id = "LIVE_APPROVAL_V12EXP_PRIMARY_V3_P000002_P000010_A005_OPERATOR"
    ...
    operator_note = "A005 continues after A004 P000001 passed and P000002 failed strict evidence quote validation; provider schema now caps evidence string length."
}

if (Test-Path -LiteralPath $approvalFile) {
    throw "Approval file already exists; create the next attempt ID instead of reusing A005: $approvalFile"
}
